...
<body class="home-1 home-2">
    ...
    <header id="inner-navigation">
        ...
        <div class="offer text-center">
            <div class="container">
                <p class="mar-0">DASHAIN SALE 20% OFF. Use discount code to get 20% discount on all our premium themes.
                    Discount Code : 20PERCENTOFF </p>
                    ...
                    <ul class="nav navbar-nav navbar-right" id="responsive-menu">
                        ...
                        if (isset($_SESSION['user_id'])) {
                           echo '
                            ...
                            echo '
                            <li>
                                <a href="logoin.php">Log in/ Sign Up  </a>
